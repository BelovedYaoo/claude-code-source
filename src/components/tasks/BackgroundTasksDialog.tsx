...
import {
  killWorkflowTask as importedKillWorkflowTask,
  retryWorkflowAgent as importedRetryWorkflowAgent,
  skipWorkflowAgent as importedSkipWorkflowAgent,
} from '../../tasks/LocalWorkflowTask/LocalWorkflowTask.js';
import { killMonitorMcp as importedKillMonitorMcp } from '../../tasks/MonitorMcpTask/MonitorMcpTask.js';
type ViewState = {
  mode: 'list';
} | {
  mode: 'detail';
...
const killWorkflowTask = feature('WORKFLOW_SCRIPTS')
  ? importedKillWorkflowTask
  : null;
const skipWorkflowAgent = feature('WORKFLOW_SCRIPTS')
  ? importedSkipWorkflowAgent
  : null;
const retryWorkflowAgent = feature('WORKFLOW_SCRIPTS')
  ? importedRetryWorkflowAgent
  : null;
const killMonitorMcp = feature('MONITOR_TOOL') ? importedKillMonitorMcp : null;
